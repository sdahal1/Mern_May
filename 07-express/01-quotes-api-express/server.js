...
//update a quote based on the index number
app.put("/api/quotes/:idx", (req,res)=>{
    quotes[req.params.idx] = req.body; //update teh quote array at specific index with the information from the form form info is req.body)
